<?php include('header.php');?>
	<div class="choose-your-system">
		...
		<div class="options-section">
				...
				<div class="row">
					<div class="col-xs-12 col-md-4">
						<div class="options-intro">
							<h2><j class="visible-xs visible-sm hidden-md hidden-lg hidden-xl hidden-xxl"></j> Total Control</h2>
							<span class="price-block" data-toggle="modal" data-target="#get-quote">$49.99 a Month<br>$199 Activation</span>
							<p class="hidden-xs hidden-sm visible-md visible-lg visible-xl visible-xxl">Lights, cameras, heating, and more— control your entire home from anywhere with the touch of a button.</p>
						</div>
						<span class="what-you-get-toggle hidden-xs hidden-sm visible-md visible-lg visible-xl visible-xxl"></span>
					...
					<div class="col-xs-12 col-md-4">
						<div class="options-intro">
							<h2><j class="visible-xs visible-sm hidden-md hidden-lg hidden-xl hidden-xxl"></j> Safe Home</h2>
							<span class="price-block" data-toggle="modal" data-target="#get-quote">$49.99 a Month<br>$69 Activation</span>
							<p class="hidden-xs hidden-sm visible-md visible-lg visible-xl visible-xxl">Everything you need to keep your home safe and sound and the ability to control it all from your phone.</p>
						</div>
						<span class="what-you-get-toggle hidden-xs hidden-sm visible-md visible-lg visible-xl visible-xxl"><j></j> what you get</span>
						<div class="what-you-get slide" style="display: none;">
					...
					<div class="col-xs-12 col-md-4">
						<div class="options-intro">
							<h2><j class="visible-xs visible-sm hidden-md hidden-lg hidden-xl hidden-xxl"></j> Hard-Wired +</h2>
							<span class="price-block" data-toggle="modal" data-target="#get-quote">$39.99 a Month<br>$69 Activation</span>
							<p class="hidden-xs hidden-sm visible-md visible-lg visible-xl visible-xxl">We’ll update your existing hardwired system with a new panel and wireless components.</p>
						</div>
						<span class="what-you-get-toggle hidden-xs hidden-sm visible-md visible-lg visible-xl visible-xxl"></span>
						<div class="what-you-get slide" style="display: none;">
			...
			<div class="container-fluid add-ons slide visible-xs visible-sm hidden-md hidden-lg hidden-xl hidden-xxl">
				<div class="row-fluid">
			...
			<div class="container slide visible-xs visible-sm hidden-md hidden-lg hidden-xl hidden-xxl">
				<div class="row">
					<div class="col-xs-12 col-md-4">
						<ul>
							<li>MySense App *</li>
