					...
					<div class="corner-stripes col-md-6">
						<div class="row">
							<div class="inner col-md-10 col-md-offset-1">
								...
								<a href="life-doesnt-stand-still.php" class="btn btn-default">Here's How <i></i></a>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="corner-stripes col-md-6 col-md-pull-6">
						<div class="row">
							<div class="inner col-md-10 col-md-offset-1">
								...
								<a href="safety-doesnt-just-happen.php" class="btn btn-default">Learn More <i></i></a>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="corner-stripes col-md-6">
						<div class="row">
							<div class="inner col-md-10 col-md-offset-1">
								...
								<a href="cutting-edge.php" class="btn btn-default">Learn More <i></i></a>
							</div>
						</div>
					</div>
				</div>
