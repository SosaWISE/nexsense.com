	...
	<div class="nexsense-system">
		...
		<div class="more-than-an-alarm clearfix">
			<div class="container-fluid">
				<div class="row-fluid">
					<div class="inner col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 text-center">
					...
					<div class="corner-stripes col-md-6">
						<div class="row">
							<div class="inner col-md-10 col-md-offset-1">
								...
								<a class="btn btn-default" href="life-doesnt-stand-still.php">Here's How <i></i></a>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="corner-stripes col-md-6 col-md-pull-6">
						<div class="row">
							<div class="inner col-md-10 col-md-offset-1">
								...
								<a class="btn btn-default" href="safety-doesnt-just-happen.php">Learn More <i></i></a>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="corner-stripes col-md-6">
						<div class="row">
							<div class="inner col-md-10 col-md-offset-1">
								...
								<a class="btn btn-default" href="cutting-edge.php">Learn More <i></i></a>
							</div>
						</div>
					</div>
				</div>
