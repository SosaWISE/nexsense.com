...
<head>
	...
	<meta name="description" content="Alarm service warranties are our way of proving confidence in our home automation & security products. If you need an alarm service, Nexsense is there." />
	<meta name="keywords" content="Nexsense, support, faq, customer service, customer support, technical support, warranty, home security, alarm system, home automation, home management, home control, smart home" />
	<title>Customer Service | Nexsense</title>
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<div>
								...
								<div class="faq-question">
									<h4>How do I change my master code?</h4>
									<div class="faq-answer">
										<p>To setup the User Codes, use the following steps:</p>
										<ol>
											<li>On the Home Screen, press SECURITY.</li>
											<li>On the Security Screen, press MENU.</li>
											<li>On the Menu Screen, press TOOLBOX.</li>
											<li>Enter the Master User Code (the factory setting is 1111).</li>
											<li>On the Toolbox Screen (1 of 3), press USER MANAGEMENT.</li>
											<li>The Users Management Screen displays three users at a time. Use the ↓ and ↑ arrows to scroll through the list.</li>
										</ol>
										<p>✓ NOTE: User Codes 0000 and 0001 are not permitted.</p>
										<p>Want to add a user code?  Press one of the ADD USER buttons.</p>
										<ol>
											<li>Enter a four-digit code for the new User Code and press OK.</li>
											<li>Enter the Code again to conﬁrm the code and press OK.</li>
											<li>A conﬁrmation screen will display, press OK.</li>
											<li>The User Code’s Access Option Screen will be displayed. The three options determine when this User Code is valid.</li>
											<li>Select one of the three options: ALWAYS; NEVER; or BY SCHEDULE.</li>
											<ul>
												<li>Select ALWAYS to set this User Code to always be valid. Press BACK.</li>
												<li>Select NEVER to set this User Code to never be valid. Press BACK.</li>
												<li>Select BY SCHEDULE set this User Code to be valid only for selected days and times. See the next section.</li>
											</ul>
										</ol>
									</div>
								</div>
