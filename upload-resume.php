...
$headers .= "Organization: Nexsense" . "\r\r\n";
$headers .= "MIME-Version: 1.0" . "\r\r\n";
//$headers .= "Content-type: text/plain; charset=iso-8859-1" . "\r\r\n";
$headers .= "Content-type: multipart/mixed; boundary=\"$boundary\"";
$headers .= "From: no-reply@nexsense.com" . "\r\r\n";
$headers .= "Reply-To: no-reply@nexsense.com" . "\r\r\n";
...
if (!empty($request->resumeData)) {
	...
	if (count($matches) > 1) {
		...
		$body .= "Content-Description: " . $request->firstName . $request->lastName . '-resume.' . $extension . "\r\n";
